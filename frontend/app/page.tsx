            ...
            <CardContent className="p-4 space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="default">{polls.filter((p) => p.isActive).length}</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Total Votes</span>
                  <span className="font-semibold">{polls.reduce((sum, p) => sum + p.totalVotes, 0)}</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">Vote on the latest polls and see results update in real-time</p>
              </div>
            </div>
